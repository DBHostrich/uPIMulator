...
struct dpu_fifo_rank_t {
    ...
    /** Worst-case free slot count as of last rd_ptr refresh; decremented per
     ** successful push. 0 means dpu_copy_to_wram_fifo must refresh rd_ptr. */
    uint32_t min_free_budget;
};
