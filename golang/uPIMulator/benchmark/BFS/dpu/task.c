...
int main() {
    ...
    uint32_t mramBase = (uint32_t) DPU_MRAM_HEAP_POINTER;
    uint32_t nodePtrs_m = mramBase + params_w->dpuNodePtrs_m;
    uint32_t neighborIdxs_m = mramBase + params_w->dpuNeighborIdxs_m;
    uint32_t nodeLevel_m = mramBase + params_w->dpuNodeLevel_m;
    uint32_t visited_m = mramBase + params_w->dpuVisited_m;
    uint32_t currentFrontier_m = mramBase + params_w->dpuCurrentFrontier_m;
    uint32_t nextFrontier_m = mramBase + params_w->dpuNextFrontier_m;
