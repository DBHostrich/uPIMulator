...
#define __RESTORE_CARRY_AND_ZERO_FLAG(x) \
        "add r0, zero, 0x00000001; ld d0, id8, " "256; stop true, 0\n" /* ... restore Z = 0, C = 0 */ \
        "add r0, mneg, 0x80000001; ld d0, id8, " "256; stop true, 0\n" /* ... restore Z = 0, C = 1 */ \
        "add r0, zero, 0x00000000; ld d0, id8, " "256; stop true, 0\n" /* ... restore Z = 1, C = 0 */ \
        "add r0, mneg, 0x80000000; ld d0, id8, " "256; stop true, 0\n" // ... restore Z = 1, C = 1 */
